...
#---------------------------------------------------------------------------------
CFLAGS		=	-g -ggdb -O3 -Wall -Wno-multichar -DDEBUG_WIFI -Wno-unused-parameter -Wextra $(MACHDEP) $(INCLUDE) -DBUILD_IOS=$(IOS)
CXXFLAGS	=	$(CFLAGS)
...
LIBS := -lcustomfat -lcustomntfs -lcustomext2fs -lvorbisidec -lmad -lfreetype \
		-lgd -ljpeg -lpng -lzip -lm -lz -lwiiuse -lwupc -lbte -lasnd -logc -ldb
#---------------------------------------------------------------------------------
